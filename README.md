...
## Welcome!
This GitHub repository contains the source code that is used to org.firstinspires.ftc.teamcode.teamcode.build an Android app to control a *FIRST* Tech Challenge competition robot.  To use this SDK, download/clone the entire project to your local computer.
...
* Several improvements to VisionPortal
  * Adds option to control whether the stream is automatically started following a `.org.firstinspires.ftc.teamcode.teamcode.build()` call on a VisionPortal Builder
...
* OnBotJava source code is automatically saved as a ZIP file on every org.firstinspires.ftc.teamcode.teamcode.build with a rolling window of the last 30 builds kept; allows recovering source code from previous builds if code is accidentally deleted or corrupted.
...
* Fixes Emergency Stop condition when an OnBotJava org.firstinspires.ftc.teamcode.teamcode.build with duplicate OpMode names occurs.
...
* In OnBotJava, clicking on org.firstinspires.ftc.teamcode.teamcode.build errors now correctly jumps to the correct location.
...
### Breaking Changes
* Updates the org.firstinspires.ftc.teamcode.teamcode.build tooling.  For Android Studio users, this change requires Android Studio Chipmunk 2021.2.1.
 ...
 * Fixes Driver Station OpMode controls becoming unresponsive if the Driver Station was set to the landscape layout and an OnBotJava org.firstinspires.ftc.teamcode.teamcode.build was triggered while an OpMode was running.
...
* Android Studio users need to be connected to the Internet the first time they org.firstinspires.ftc.teamcode.teamcode.build the app (in order to download needed packages for the org.firstinspires.ftc.teamcode.teamcode.build).
...
* Update/refresh org.firstinspires.ftc.teamcode.teamcode.build infrastructure
    ...
    * Fix reported org.firstinspires.ftc.teamcode.teamcode.build timestamp in 'About' screen
...
* Fix RenderScript usage
    ...
    * Use RenderScript in Java mode, not native: simplifies org.firstinspires.ftc.teamcode.teamcode.build
...
* OnBotJava
    ...
    * It's possible for a org.firstinspires.ftc.teamcode.teamcode.build to be queued, but not started. The OnBot Java org.firstinspires.ftc.teamcode.teamcode.build console will display a warning if this occurs.
 ...
 * Updates org.firstinspires.ftc.teamcode.teamcode.build tooling and target SDK.
 * Compliance with Google's permissions infrastructure (Required after org.firstinspires.ftc.teamcode.teamcode.build tooling update).
 ...
 * Added google() repo to org.firstinspires.ftc.teamcode.teamcode.build.gradle because aapt2 must be downloaded from the google() repository beginning with version 3.2 of the Android Gradle Plugin.
     - Important Note: Android Studio users will need to be connected to the Internet the first time org.firstinspires.ftc.teamcode.teamcode.build the ftc_app project.
     - Internet connectivity is required for the first org.firstinspires.ftc.teamcode.teamcode.build so the appropriate files can be downloaded from the Google repository.
 ...
 * Fixes problem where OnBot Java would not org.firstinspires.ftc.teamcode.teamcode.build on REV Robotics Control Hub.
 * Fixes problem where OnBot Java would not org.firstinspires.ftc.teamcode.teamcode.build if the date and time on the Robot Controller device was "rewound" (set to an earlier date/time).
 ...
 * OnBot Java
    - Sometimes when you push the org.firstinspires.ftc.teamcode.teamcode.build button to org.firstinspires.ftc.teamcode.teamcode.build all OpModes, the RC returns an error message that the org.firstinspires.ftc.teamcode.teamcode.build failed.  If you press the org.firstinspires.ftc.teamcode.teamcode.build button a second time, the org.firstinspires.ftc.teamcode.teamcode.build typically suceeds.

## Version 3.2 (built on 17.08.02)

This version of the software introduces the "OnBot Java" Development Tool.  Similar to the FTC Blocks Development Tool, the FTC OnBot Java Development Tool allows a user to create, edit and org.firstinspires.ftc.teamcode.teamcode.build OpModes dynamically using only a Javascript-enabled web browser.
 ...
 * Changes in the Android SDK, JDK and org.firstinspires.ftc.teamcode.teamcode.build tool requirements (minsdk=19, java 1.7, org.firstinspires.ftc.teamcode.teamcode.build tools 23.0.3).
 ...
 * Added app org.firstinspires.ftc.teamcode.teamcode.build time to About activity for driver station and robot controller apps.
 ...
 * Cleaned up org.firstinspires.ftc.teamcode.teamcode.build.gradle file.
